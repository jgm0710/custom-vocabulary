...
public class JwtTokenProvider {
    ...
    // JWT 토큰 생성
    public String createToken(String joinId, List<String> roles) {
        Claims claims = Jwts.claims().setSubject(joinId); // JWT payload 에 저장되는 정보단위
    ...
    public Authentication getAuthentication(String token) {
        UserDetails userDetails = loginService.loadUserByUsername(this.getJoinId(token));
        return new UsernamePasswordAuthenticationToken(userDetails, "", userDetails.getAuthorities());
    }

    // 토큰에서 회원 정보 추출
    public String getJoinId(String token) {
